...
2. **Attacks are telegraphed, never ambushes.** Every wave gets a 60-second warning: minimap tile flashes violet, klaxon variant of sound #10, banner with sector name. The arcade moment is the *response*, not the surprise.
